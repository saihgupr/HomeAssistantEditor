...
async function syncHAMetadata(type = 'all') {
    ...
    try {
        ...
        try {
            ...
            console.error('[HA Sync] Failed to parse JSON response. Response text:', text);
            throw new Error('Response is not valid JSON. Start of response: ' + text.substring(0, 150));
        }
